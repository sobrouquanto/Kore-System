...
const TAB_LABELS: Record<TabId, string> = Object.fromEntries(NAV_ITEMS.map(n => [n.id, n.label])) as any
    ...
    <div className="layout">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'sidebar-open' : ''}`}>
        ...
        <div className="sidebar-footer">
          ...
          <button onClick={doLogout} style={{ background: 'transparent', border: 'none', color: 'rgba(255,255,255,0.25)', cursor: 'pointer', fontSize: '16px', padding: '4px', flexShrink: 0 }} title="Sair">⏻</button>
        </div>
      </aside>
